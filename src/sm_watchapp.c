...
*/
	...
	text_mail_layer = text_layer_create(GRect(25, 168-16, 25, 15));
	...
	text_sms_layer = text_layer_create(GRect(50, 168-16, 25, 15));
	...
	text_phone_layer = text_layer_create(GRect(0, 168-16, 25, 15));
	...
	text_battery_layer = text_layer_create(GRect(40, -3, 40, 15));
